...
function SymbolPaletteInner({
  ...
  return (
    ...
    >
      <div
        className="bg-white/45 backdrop-blur-[24px] backdrop-saturate-150 border border-white/45 rounded-xl w-full max-w-xl shadow-[inset_0_1px_2px_rgba(255,255,255,0.8),0_8px_30px_rgba(0,0,0,0.1)] overflow-hidden animate-in fade-in zoom-in-95 duration-150"
