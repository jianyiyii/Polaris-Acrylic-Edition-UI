    ...
    <form onSubmit={(e) => e.preventDefault()} className="p-2">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-1.5 bg-white/25 backdrop-blur-[20px] border border-white/35 rounded-xl text-sm text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
        />
